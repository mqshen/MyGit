...
from lib.vcs.utils import author_name, author_email
from lib.vcs.utils.lazy import LazyProperty
from lib.vcs.utils.helpers import get_dict_for_attrs
from lib.vcs.conf import settings

from lib.vcs.exceptions import ChangesetError, EmptyRepositoryError, \
...
class EmptyChangeset(BaseChangeset):
    ...
    @LazyProperty
    def branch(self):
        from lib.vcs.backends import get_backend
