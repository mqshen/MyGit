...
from lib.vcs.conf import settings
from lib.vcs.exceptions import RepositoryError
from lib.vcs.exceptions import ChangesetError
from lib.vcs.exceptions import NodeDoesNotExistError
from lib.vcs.exceptions import VCSError
from lib.vcs.exceptions import ChangesetDoesNotExistError
from lib.vcs.exceptions import ImproperArchiveTypeError
from lib.vcs.backends.base import BaseChangeset, EmptyChangeset
from lib.vcs.nodes import FileNode, DirNode, NodeKind, RootNode, \
    RemovedFileNode, SubModuleNode, ChangedFileNodesGenerator,\
    AddedFileNodesGenerator, RemovedFileNodesGenerator
from lib.vcs.utils import date_fromtimestamp
from lib.vcs.utils.lazy import LazyProperty
...
class GitChangeset(BaseChangeset):
    ...
    @LazyProperty
    def committer(self):
        return getattr(self._commit, self._committer_property)

    @LazyProperty
    def author(self):
        return getattr(self._commit, self._author_property)
    ...
    def fill_archive(self, stream=None, kind='tgz', prefix=None,
        ...
        if kind == 'zip':
            ...
            frmt = 'tar'
        _git_path = options.repositoryPath
    ...
    def get_nodes(self, path, tag=None):
        ...
        for name, stat, id in tree.iteritems():
            if objects.S_ISGITLINK(stat):
                dirnodes.append(SubModuleNode(name, url=None, changeset=id, alias=als))
                continue
            ...
            if isinstance(obj, objects.Tree):
                ...
                filenodes.append(FileNode(obj_path, changeset=changeset, mode=stat))
            else:
