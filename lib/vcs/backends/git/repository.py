...
from lib.vcs.backends.base import BaseRepository
from lib.vcs.exceptions import BranchDoesNotExistError
from lib.vcs.exceptions import ChangesetDoesNotExistError
from lib.vcs.exceptions import EmptyRepositoryError
from lib.vcs.exceptions import RepositoryError
from lib.vcs.exceptions import TagAlreadyExistError
from lib.vcs.exceptions import TagDoesNotExistError
from lib.vcs.utils import makedate, date_fromtimestamp
from lib.vcs.utils.lazy import LazyProperty, ThreadLocalLazyProperty
from lib.vcs.utils.paths import abspath
from lib.vcs.utils.paths import get_user_home
from .workdir import GitWorkdir
from .changeset import GitChangeset
from .inmemory import GitInMemoryChangeset
from .config import ConfigFile
from lib import subprocessio
...
class GitRepository(BaseRepository):
    ...
    def _get_revision(self, revision):
        ...
        is_bstr = lambda o: isinstance(o, str)
    ...
    def branches(self):
        ...
        _branches = [x[0]
                     for x in self._parsed_refs.items() if x[1][1] == 'H']
        return sorted(_branches, key=sortkey, reverse=False)
    ...
    def _get_tags(self):
        ...
        sortkey = lambda ctx: ctx[0]
        _tags = [(x[0], x[1][0])
                 for x in self._parsed_refs.items() if x[1][1] == 'T']
        return sorted(_tags, key=sortkey, reverse=True)
