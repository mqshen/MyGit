...
from lib.vcs.nodes import FileNode, SubModuleNode
from lib.vcs.backends.base import EmptyChangeset
from core.escape import xhtml_escape as escape
...
class DiffProcessor(object):
    ...
    def _get_header(self, diff_chunk):
        ...
        if self.vcs == 'git':
            ...
            return match.groupdict(), map(self._escaper, diff.splitlines(1))
        elif self.vcs == 'hg':
    ...
    def as_html(self, table_class='file-code file-diff  hide-line-numbers line-number-attrs', 
                line_class='file-diff-line',
                old_lineno_class='diff-line-num linkable-line-number', 
                new_lineno_class='diff-line-num linkable-line-number',
                code_class='diff-line-code', enable_comments=False, parsed_lines=None):
        """
